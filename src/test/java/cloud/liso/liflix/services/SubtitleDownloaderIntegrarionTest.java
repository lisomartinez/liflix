package cloud.liso.liflix.services;
...
import cloud.liso.liflix.services.subtitles.open_subtitles.OpenSubsDownloader;
import cloud.liso.liflix.services.subtitles.open_subtitles.OpenSubsFields;
import cloud.liso.liflix.services.subtitles.open_subtitles.OpenSubsRestClient;
...
@RestClientTest({OpenSubsDownloader.class, OpenSubsRestClient.class, OpenSubsFields.class})
...
public class SubtitleDownloaderIntegrarionTest {
    ...
    void getList_validRequest_returnsListOfSubtitles() {
        ...
        RequestSubtitleDto req = RequestSubtitleDto.builder()
                ...
                .language("eng")
                .build();
        List<OpenSubtitlesSubtitleDto> list = subtitleDownloader.getList(req);
