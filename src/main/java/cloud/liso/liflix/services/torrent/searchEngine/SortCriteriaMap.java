package cloud.liso.liflix.services.torrent.searchEngine;

import cloud.liso.liflix.services.torrent.SortPolicy;
import cloud.liso.liflix.services.torrent.searchEngine.criteria.BestResolutionMaxSeedersSortPolicy;
import cloud.liso.liflix.services.torrent.searchEngine.criteria.BestSpeedSortPolicy;
import cloud.liso.liflix.services.torrent.searchEngine.criteria.MaxSeedersSortPolicy;
import cloud.liso.liflix.services.torrent.searchEngine.criteria.OnlyHDReadyMostSeedersSortPolicy;
