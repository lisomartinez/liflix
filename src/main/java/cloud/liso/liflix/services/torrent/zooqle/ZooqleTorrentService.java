...
import cloud.liso.liflix.services.torrent.TorrentAssociatedEntitiesService;
...
public class ZooqleTorrentService implements TorrentService {
    ...
    private ZooqleTorrentFetcher zooqleTorrentFetcher;
    ...
    public List<Torrent> getTorrents(Request request, SortPolicy sortPolicy) {
        ...
        if (list.isPresent() && lastUpdateTimeIsLessThanTTL(list.get())) {
            ...
            List<Torrent> fetchedTorrents = zooqleTorrentFetcher.torrentsFrom(request);
