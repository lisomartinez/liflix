...
@Service
public class TorrentComponentsRepositoryFacade {
    ...
    @Autowired
    public TorrentComponentsRepositoryFacade(CodecRepository codecRepository, ResolutionRepository resolutionRepository, ReleaseTypeRepository releaseTypeRepository) {
        this.codecRepository = codecRepository;
        this.resolutionRepository = resolutionRepository;
        this.releaseTypeRepository = releaseTypeRepository;
    }

    public List<Torrent> getOrSaveComponentsOfAll(List<Torrent> torrents) {
