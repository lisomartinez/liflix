...
@Service
public class TorrentAssociatedEntitiesRepositoryFacade {
    ...
    @Autowired
    public TorrentAssociatedEntitiesRepositoryFacade(CodecRepository codecRepository, ResolutionRepository resolutionRepository, ReleaseTypeRepository releaseTypeRepository) {
